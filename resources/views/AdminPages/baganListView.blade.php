...
@section('Body-HTML')
    ...
    <div x-data="{ sidebarOpen: false, ui: { openMenu: null } }" class="min-h-screen flex bg-pink-50 dark:bg-gray-900">
        <!-- Mobile backdrop -->
        ...
        <aside
            ...
            class="fixed z-30 inset-y-0 left-0 w-64 transform bg-white dark:bg-gray-800 border-r border-pink-200 dark:border-gray-700 overflow-y-auto transition-transform duration-200 ease-in-out lg:relative lg:transform-none">
        ...
        <!-- Main content -->
        <div class="flex-1 flex flex-col w-full lg:pl-0">
            <header class="w-full bg-white dark:bg-gray-800 border-b border-pink-200 dark:border-gray-700 sticky top-0 z-10">
                <div class="w-full px-3 sm:px-4 lg:px-6 py-3 flex items-center justify-between">
                    <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                        ...
                        <h1 class="text-sm sm:text-md lg:text-lg font-semibold text-gray-900 dark:text-white truncate">Bagan List</h1>
                    </div>
            ...
            <main class="flex-1 p-3 sm:p-4 lg:p-6 w-full min-w-0 space-y-4 sm:space-y-6">
                <div class="w-full max-w-full overflow-hidden">
                    <livewire:bagan.add />
                </div>
                <div class="w-full max-w-full overflow-hidden">
                    <livewire:bagan.baganlisttable />
                </div>
            </main>
        </div>
    </div>
    ...
    <style>
        ...
        @media (max-width: 640px) {
            ...
            /* Ensure sidebar doesn't affect layout on mobile */
            .lg\:pl-64 {

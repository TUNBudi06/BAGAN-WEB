...
@section('Body-HTML')
    ...
    <div x-data="{ sidebarOpen: false, ui: { openMenu: null } }" class="min-h-screen flex bg-gray-100 dark:bg-gray-900">
        ...
        <aside
            ...
            class="fixed z-30 inset-y-0 left-0 w-64 transform bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 overflow-y-auto transition-transform duration-200 ease-in-out lg:relative lg:transform-none">
